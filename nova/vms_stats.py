...
class Host(object):
    ...
    def __init__(self, config):
        ...
        LOG.info("Found %s active VMs at the host." % len(self.vms))
    ...
    def watch(self):
        ...
        for vm in self.vms:
            ...
            # sleep a bit to unsync checking different VMs (avoid checking
            #   disks of different VMs in the one timeframe)
            time.sleep(0.5)
